      ...
      <header className="bg-white/80 backdrop-blur-sm border-b py-4 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-indigo-600 text-white grid place-items-center font-bold">CRM</div>
            <div>
              <h1 className="text-lg font-semibold">Mini CRM  Campaigns</h1>
              <p className="text-sm text-slate-500">Test campaigns, segments and delivery (demo)</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <SegmentPicker />
